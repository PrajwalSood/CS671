...
plt.savefig('metrics/RNN_hw/train_confusion_matrix.png')
plt.show()
...
ax.set_title('Confusion Matrix')
ax.xaxis.set_ticklabels(['a', 'ai', 'bA', 'chA', 'dA']); ax.yaxis.set_ticklabels(['a', 'ai', 'bA', 'chA', 'dA'])
plt.savefig('metrics/RNN_hw/val_confusion_matrix.png')
plt.show()
...
ax.set_title('Confusion Matrix')
ax.xaxis.set_ticklabels(['a', 'ai', 'bA', 'chA', 'dA']); ax.yaxis.set_ticklabels(['a', 'ai', 'bA', 'chA', 'dA'])
plt.savefig('metrics/RNN_hw/test_confusion_matrix.png')
plt.show()
############################ LSTM
...
ax.set_title('Confusion Matrix')
ax.xaxis.set_ticklabels(['a', 'ai', 'bA', 'chA', 'dA']); ax.yaxis.set_ticklabels(['a', 'ai', 'bA', 'chA', 'dA'])
plt.savefig('metrics/LSTM_hw/train_confusion_matrix.png')
plt.show()
...
ax.set_title('Confusion Matrix')
ax.xaxis.set_ticklabels(['a', 'ai', 'bA', 'chA', 'dA']); ax.yaxis.set_ticklabels(['a', 'ai', 'bA', 'chA', 'dA'])
plt.savefig('metrics/LSTM_hw/val_confusion_matrix.png')
plt.show()
...
ax.set_title('Confusion Matrix')
ax.xaxis.set_ticklabels(['a', 'ai', 'bA', 'chA', 'dA']); ax.yaxis.set_ticklabels(['a', 'ai', 'bA', 'chA', 'dA'])
plt.savefig('metrics/LSTM_hw/test_confusion_matrix.png')
plt.show()