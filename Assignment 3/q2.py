...
fm1 = conv.forward((img1/255) - 0.5)
fm2 = []
for i in range(fm1.shape[-1]):
  fm2.append(conv2.forward(fm1[:,:,i]))

fm2 = np.array(fm2)
#sum over 0 axis
fm2 = np.sum(fm2, axis=0)

filters1 = conv.filters
filters2 = conv2.filters
...
img1 = cv2.imread('data/train/chandelier/image_0004.jpg')
#grayscale the imaege
img1 = cv2.cvtColor(img1, cv2.COLOR_BGR2GRAY)/255.
#resize
img1 = cv2.resize(img1, (224, 224))
...
img1 = cv2.imread('data/train/ketch/image_0002.jpg')
#grayscale the imaege
img1 = cv2.cvtColor(img1, cv2.COLOR_BGR2GRAY)/255.
#resize
img1 = cv2.resize(img1, (224, 224))
